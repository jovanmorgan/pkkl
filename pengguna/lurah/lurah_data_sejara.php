...
// Jika pengguna sudah login, Anda dapat melanjutkan menampilkan halaman lurah.php seperti biasa
?>
<!DOCTYPE html>
<html lang="en">
                                ...
                                <div class="modal-body">
                                    <form id="editForm3" action="profile/edit3.php" method="POST">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea class="form-control" name="deskripsi_sejara"
                                                id="deskripsiTextarea" rows="20" style="height: 400px;"></textarea>
                                        </div>
                                    </form>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary"
