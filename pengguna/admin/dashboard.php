        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12 text-center">
                                            <h2 class="card-title stylish-title">
                                                Selamat Datang Di Website Pelayanan Kependudukan Kelurahan Lasiana Kota Kupang
                                            </h2>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./dashboard'">
                            ...
                            <div class="card-body p-4">
                                Dashboard admin pada Pelayanan Kependudukan Kelurahan Lasiana
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./admin_data_penduduk'">
                            <div class="card-header">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./admin_data_kematian'">
                            <div class="card-header">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./admin_data_kelahiran'">
                            <div class="card-header">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./admin_data_kartu_keluarga'">
                            <div class="card-header">
                                <h5 class="card-category">Total Kartu Keluarga</h5>
                                <?php
                                include '../../keamanan/koneksi.php';
