...
<body class="white-content">
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <hr>
                                            <p class="category"> Halaman ini berfungsi untuk mengedit dan merubah data gambar dan text yang akan dimunculkan pada halaman home <br> Click data yang ingin diedit</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    ...
                                    <form id="editForm" action="profile/edit1.php" method="POST" enctype="multipart/form-data">
                                        ...
                                        <input type="hidden" id="gambar_home_lama" name="gambar_home_lama">
                                        <hr>
                                        <div class="form-group">
                                            <label for="editkover">Data Gambar :</label>
                                            <input type="file" class="form-control-file d-none" id="editkover" name="gambar_home" onchange="previewImageAndSetExisting(this, 'editkoverPreview1', 'editkoverImage1')">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="editForm2" action="profile/edit2.php" method="POST" enctype="multipart/form-data">
                                        <input type="hidden" id="id_home2" name="id_home">
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="editForm3" action="profile/edit3.php" method="POST">
                                        <input type="hidden" id="id_home3" name="id_home">
                                        <div class="form-group">
                                            <label for="deskripsiTextarea">Deskripsi</label>
                                            <textarea class="form-control" name="deskripsi_home" id="deskripsiTextarea" rows="20" style="height: 400px;"></textarea>
                                        </div>
                                    </form>
                                    <div class="modal-footer">
                                        <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
                            ...
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <form id="editForm4" action="profile/edit4.php" method="POST">
                                        <input type="hidden" id="id_home4" name="id_home">
                                        <div class="form-group">
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mu-latest-course-single">
                                                                            ...
                                                                            <div class="mu-latest-course-single-content">
                                                                                <h2 class="text-center">Pelayanan Kependudukan
                                                                                    Kelurahan Lasiana
                                                                                </h2>
                                                                                <div id="data3">
                                                                                ...
                                                                                <div id="dataGambar2">
                                                                                    ...
                                                                                    $sql = "SELECT id_home, gambar_struktur FROM home";
                                                                                    $result = $koneksi->query($sql);
                                                                                    ...
                                                                                    if ($result->num_rows > 0) {
                                                                                        while ($row = $result->fetch_assoc()) {
                                                                                            ...
                                                                                            echo '<a href="#" onclick="openEditModal2(' . $row["id_home"] . ', \'' . $gambar_struktur . '\')">';
    ...
    <script>
        ...
        function openEditModal(id_gambar, gambar_home) {
            // Isi data ke dalam form edit
            document.getElementById('id_home').value = id_gambar;

            // Simpan URL gambar saat ini
            document.getElementById('gambar_home_lama').value = gambar_home;

            // Menampilkan preview gambar_home jika ada
            if (gambar_home !== '') {
                var koverImage = document.getElementById('editkoverImage1');
                koverImage.src = gambar_home;
        ...
        function previewImageAndSetExisting(input, previewId, inputId) {
            ...
            if (fileType.match('image.*')) {
                ...
                document.getElementById('gambar_home_lama').value = '';
            } else {
                $.notify({
        ...
        function openEditModal2(id_gambar2, gambar_struktur) {
            // Isi data ke dalam form edit
            document.getElementById('id_home2').value = id_gambar2;
        ...
        function openEditModal3(id_home, deskripsi_home) {
            // Ubah <br> kembali menjadi newline (\n)
            deskripsi_home = deskripsi_home.replace(/<br\s*\/?>/gi, '\n');

            // Set value dari deskripsi_home ke dalam textarea modal
            document.getElementById('id_home3').value = id_home;
            document.getElementById('deskripsiTextarea').value = deskripsi_home;
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            document.getElementById('editDeskripsi').addEventListener('click', function(event) {
                ...
                var deskripsi_home = deskripsiTextarea.replace(/\n/g, '<br>');
        ...
        function openEditModal4(id_home, visi, misi) {
            // Set value dari visi dan misi ke dalam textarea modal
            document.getElementById('id_home4').value = id_home;
