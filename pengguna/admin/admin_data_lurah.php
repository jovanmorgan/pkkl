...
<body class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="lurah/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" min="0" class="form-control" id="nip" name="nip" required>
                                </div>
                                <div class="form-group">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data lurah -->
                            <form id="form_edit" action="lurah/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_lurah" name="id_lurah">
                                <div class="form-group">
                                    <label for="nama">Nama :</label>
                                ...
                                <div class="form-group">
                                    <label for="nip">nip :</label>
                                    <input type="number" min="0" class="form-control" id="editnip" name="nip" required>
                                </div>
                                <div class="form-group">
                                    <label for="username">Username :</label>
            ...
            <script>
                function openEditModal(id_lurah, nip, nama, username, password) {
                    // Isi data ke dalam form edit
                    document.getElementById('editid_lurah').value = id_lurah;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Data Lurah Haya wajib 1 saja Tidak Boleh lebih</p>
                                            <p class="category">Clik untuk menambah data lurah jika belum adah</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'lurah/tambah.php', true);
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (response === 'success') {
                            ...
                            swal("Error", "Data Username lurah Sudah Ada Silakan Gunakan data username lain", "info");
                        } else if (response === 'data_sudah_ada') {
                            swal("Data Lurah Full!", "Data Lurah Maximal 1 Data", "info");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'lurah/edit.php', true);
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (response === 'success') {
                            ...
                            swal("Error", "Data yang anda masukan belum lengkap", "error");
                        } else if (response === 'data_nip_sudah_ada') {
                            swal("Error", "Akun Sudah ada silakan gunakan akun lain", "info");
                        } else if (response === 'nip_belum_pas') {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'lurah/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'lurah/load_table.php', true);
            xhrTable.send();
        }
    </script>
