                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Silakan lihat data data kk</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <!-- Tombol alat_export -->
                                                    <a href="kk/export" target="_blank" class="btn btn-info btn-block"
                                        ...
                                        <tbody>
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <a href='lurah_detail_kk?id_kk=" . htmlspecialchars($row['id_kk'], ENT_QUOTES) . "' target='_blank' class='btn btn-info btn-sm'>Detail</a>
                                                </td>";
                                                    echo "</tr>";
