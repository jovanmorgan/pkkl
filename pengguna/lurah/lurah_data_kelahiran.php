                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kelahiran/tambah.php" method="POST"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="kelahiran/edit.php" method="POST"
                                enctype="multipart/form-data">
                                <input type="hidden" id="editid_kelahiran" name="id_kelahiran">
                                <div class="form-group">
                                    <label for="anak_id_penduduk">Anak :</label>
                                    <select class="form-control" id="editanak_id_penduduk" name="anak_id_penduduk"
                                        required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                ...
                                <div class="form-group">
                                    <label for="ibu_id_penduduk">Ibu :</label>
                                    <select class="form-control" id="editibu_id_penduduk" name="ibu_id_penduduk"
                                        required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                ...
                                <div class="form-group">
                                    <label for="bapa_id_penduduk">Ayah :</label>
                                    <select class="form-control" id="editbapa_id_penduduk" name="bapa_id_penduduk"
                                        required>
                                        <option value="" selected>Silakan Pilih</option>
                                        <?php
                                        // Menggunakan include untuk menyertakan file koneksi
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Silakan lihat data data kelahiran</p>
                                            <hr>
                                        </div>
                                    </div>
                                </div>
