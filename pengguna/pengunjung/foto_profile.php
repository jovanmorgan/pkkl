                                        ...
                                        if (isset($_SESSION['id_pengunjung'])) {
                                            ...
                                            if ($result) {
                                                ...
                                                if (mysqli_num_rows($result) > 0) {
                                                    ...
                                                    <?php endif; ?>
                                                    <h5 class="title"><?php echo $pengunjung['nama']; ?></h5>
                                                </div>
                                ...
                                <div class="col-md-8">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <form id="editDataFp">
                                                <div class="row">
                                                    <input type="hidden" class="form-control" name="id_pengunjung"
                                                        id="id_pengunjung" value="<?php echo $pengunjung['id_pengunjung']; ?>">
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            <label>Nama</label>
                                                            <input type="text" class="form-control" placeholder="nama" name="nama"
                                                                id="nama" value="<?php echo $pengunjung['nama']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Username"
                                                                ...
                                                                value="<?php echo $pengunjung['username']; ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-md-12">
                                                        <div class="form-group">
                                                            ...
                                                            <input type="text" class="form-control" placeholder="Password"
                                                                ...
                                                                value="<?php echo $pengunjung['password']; ?>">
                                                        </div>
                                                    </div>
                                                </div>
            ...
            <footer class="footer">
                <div class="container-fluid">
                    ...
                    <div class="copyright">
                        ...
                        </script> Dibuat Oleh Sherly <i class="tim-icons icon-heart-2"></i>
                    </div>
                </div>
            </footer>
        </div>
