...
// Jika pengguna sudah login, Anda dapat melanjutkan menampilkan halaman pengunjung.php seperti biasa
?>
<!DOCTYPE html>
<html lang="en">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category"> Halaman ini berfungsi untuk mengedit dan merubah data
                                                gambar dan text yang akan dimunculkan pada halaman Sejarah <br> Click
                                                data yang ingin diedit</p>
                                        </div>
                                    </div>
                                </div>
                            </div>
                                                                    ...
                                                                    <div class="col-md-12">
                                                                        <div class="mu-latest-course-single">
                                                                            ...
                                                                            <div class="mu-latest-course-single-content">
                                                                                <h2>Pelayanan Kependudukan Kelurahan
                                                                                    Lasiana</h2>
                                                                                <div id="data3">
                                                                                    <?php
                                                                                    include '../../keamanan/koneksi.php';
