...
$select_query = "SELECT fp FROM pengunjung WHERE id_pengunjung = '$id_pengunjung'";
...
// Update nama gambar di tabel pengunjung berdasarkan id_pengunjung
$update_query = "UPDATE pengunjung SET fp = '$filename' WHERE id_pengunjung = '$id_pengunjung'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel pengunjung
