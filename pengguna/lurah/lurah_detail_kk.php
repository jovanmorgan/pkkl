            ...
            <div class="sidebar-wrapper badge-warning">
                <div class="logo">
                    <a href="javascript:void(0)" class="simple-text logo-mini">
                        <img src="../../images/logo_pdetail_kkl.png" width="50px" alt=""
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="detail_kk/tambah.php" method="POST"
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="detail_kk/edit.php" method="POST"
                                enctype="multipart/form-data">
                                    ...
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    <!-- Tombol alat_export -->
                                                    <a href="detail_kk/export?id_kk=<?php echo $id_kk; ?>"
