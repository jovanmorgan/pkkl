...
<body class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kematian/tambah.php" method="POST" enctype="multipart/form-data">
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data kematian -->
                            <form id="form_edit" action="kematian/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_kematian" name="id_kematian">
                                <div class="form-group">
                                    <label for="id_penduduk">Penduduk:</label>
                                ...
                                <div class="form-group">
                                    <label for="tgl_kematian">Tanggal Kematian :</label>
                                    <input type="date" class="form-control" id="edittgl_kematian" name="tgl_kematian" required>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Close</button>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_kematian, id_penduduk, tgl_kematian) {
                    // Isi data ke dalam form edit
                    document.getElementById('editid_kematian').value = id_kematian;
                    document.getElementById('editid_penduduk').value = id_penduduk;
                    document.getElementById('edittgl_kematian').value = tgl_kematian;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data Kematian</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'kematian/tambah.php', true);
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        } else if (response === 'data_id_kematian_sudah_ada') {
                            swal("Error", "Data kematian Pada Penduduk Sudah Ada!", "info");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'kematian/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'kematian/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'kematian/load_table.php', true);
            xhrTable.send();
        }
    </script>
