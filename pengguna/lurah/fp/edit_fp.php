...
$select_query = "SELECT fp FROM lurah WHERE id_lurah = '$id_lurah'";
...
// Update nama gambar di tabel lurah berdasarkan id_lurah
$update_query = "UPDATE lurah SET fp = '$filename' WHERE id_lurah = '$id_lurah'";
$update_result = mysqli_query($koneksi, $update_query);

if ($update_result) {
    // Berhasil menyimpan gambar dan update nama gambar di tabel lurah
