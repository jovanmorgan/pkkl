...
$check_query_penduduk = "SELECT * FROM penduduk WHERE nik = '$nik'";
...
$query = "INSERT INTO penduduk (nama, nik, jk, agama, tempat_lahir, tanggal_lahir, alamat) 
        VALUES ('$nama', '$nik', '$jk', '$agama', '$tempat_lahir', '$tanggal_formatted', '$alamat_data')";
