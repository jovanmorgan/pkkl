                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="galery/tambah.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file d-none" id="kover" name="foto" onchange="previewImage(this, 'koverPreview')" accept="image/*">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_edit" action="galery/edit.php" method="POST" enctype="multipart/form-data">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="datetime-local" class="form-control" id="edittanggal" name="tanggal" required>
                                </div>
                                <div class="form-group">
                                    <label for="deskripsi">Deskripsi:</label>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="file" class="form-control-file d-none" id="editKover" name="foto" onchange="previewImageAndSetExisting(this, 'editkoverPreview')" accept="image/*">
