        ...
        <div class="main-panel">
            ...
            <div class="content">
                <div class="row">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./dashboard'">
                            ...
                            <div class="card-body p-4">
                                Dashboard lurah pada Pelayanan Kependudukan Kelurahan Lasiana
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./lurah_data_penduduk'">
                            <div class="card-header">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./lurah_data_kematian'">
                            <div class="card-header">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./lurah_data_kelahiran'">
                            <div class="card-header">
                    ...
                    <div class="col-lg-4">
                        <div class="card card-chart" onclick="location.href='./lurah_data_kk'">
                            <div class="card-header">
