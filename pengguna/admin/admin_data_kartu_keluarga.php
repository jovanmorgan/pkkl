...
<body class="white-content">
    <div class="wrapper">
        ...
        <div class="main-panel">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <form id="form_tambah" action="kk/tambah.php" method="POST" enctype="multipart/form-data">

                                <div class="form-group">
                                    <label for="nikk">Nomor Induk Kartu Keluarga :</label>
                                    <input type="number" class="form-control" id="nikk" name="nikk" required>
                                </div>
            ...
            <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- Form untuk menambahkan atau mengedit data kk -->
                            <form id="form_edit" action="kk/edit.php" method="POST" enctype="multipart/form-data">
                                <input type="hidden" id="editid_kk" name="id_kk">

                                <div class="form-group">
                                    <label for="nikk">Nomor Induk Kartu Keluarga :</label>
                                    <input type="number" class="form-control" id="editnikk" name="nikk" required>
                                </div>
            ...
            <!-- js edit -->
            <script>
                function openEditModal(id_kk, nikk) {
                    document.getElementById('editid_kk').value = id_kk;
                    document.getElementById('editnikk').value = nikk;
                                ...
                                <div class="places-buttons">
                                    <div class="row">
                                        <div class="col-md-6 ml-auto mr-auto text-center">
                                            ...
                                            <p class="category">Clik untuk menambah data kk</p>
                                            <hr>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-lg-8 ml-auto mr-auto">
                                            <div class="row justify-content-center align-items-center">
                                                <div class="col-md-4">
                                                    ...
                                                    <!-- Tombol alat_export -->
                                                    <a href="kk/export" target="_blank" class="btn btn-info btn-block" data-toggle="tooltip" data-original-title="Edit user">
                                                        EXPORT DATA
                                                    </a>
                                                </div>
                                            </div>
                                        ...
                                        <tbody>
                                            ...
                                            if ($result) {
                                                ...
                                                while ($row = mysqli_fetch_assoc($result)) {
                                                    ...
                                                    <a href='admin_detail_kk?id_kk=" . htmlspecialchars($row['id_kk'], ENT_QUOTES) . "' target='_blank' class='btn btn-info btn-sm'>Detail</a>
                                                </td>";
                                                    echo "<td class='text-center'>
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_tambah').addEventListener('submit', function(event) {
                ...
                xhr.open('POST', 'kk/tambah.php', true);
                xhr.onload = function() {
                    ...
                    if (xhr.status === 200) {
                        ...
                        if (response === 'success') {
                            ...
                            swal("Error", "Data NIK kk Sudah Ada Silakan Gunakan data lain", "info");
        ...
        document.addEventListener('DOMContentLoaded', function() {
            document.getElementById('form_edit').addEventListener('submit', function(event) {
                ...
                var xhr = new XMLHttpRequest();
                xhr.open('POST', 'kk/edit.php', true);
                xhr.onload = function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        ...
                        xhr.open('POST', 'kk/hapus.php', true);
        ...
        function loadTable() {
            ...
            xhrTable.open('GET', 'kk/load_table.php', true);
            xhrTable.send();
        }
    </script>
